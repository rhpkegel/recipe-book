...
export const exampleRecipe2: Recipe = {
  id: 2,
  title: 'Chef John\'s Hungarian Dessert',
  ingredients: [{
    name: 'Meat mixture',
    ingredients: [
      {
...
export const exampleRecipe3: Recipe = {
  id: 2,
  title: 'Chef John\'s Hungarian Starter',
  ingredients: [{
    name: 'Meat mixture',
    ingredients: [
      {
...
export const exampleRecipeBook: Recipe[] = [exampleRecipe3, exampleRecipe, exampleRecipe2, exampleRecipe3, exampleRecipe, exampleRecipe2, exampleRecipe2]
